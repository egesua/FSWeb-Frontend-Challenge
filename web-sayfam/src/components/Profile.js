        ...
        <div className={"flex xl:pt-[3.6rem]  xl:flex-row  flex-col "}>
            ...
            <div className={"flex flex-col text-left  pt-[3.7rem]"}>
              ...
              <div>
                ...
                <div className={"flex pt-[2.1rem]"}>
                  ...
                  >
                    Dokuz Eylul University, Mathematics, 2022
                  </p>
                </div>
          ...
          <div className={"xl:w-[36.5vw] w-[94vw] "}>
            <div className={"xl:pl-[7rem] pl-[2rem] text-left pt-[3.7rem] "}>
              ...
              >
                I am a graduate of Dokuz Eylul University's Mathematics
                Department.{" "}
              </p>{" "}
              <p
                className={
              ...
              >
                {" "}
                On this page, I have developed a website using the training I
                received from Workintech.
              </p>
            </div>
          </div>
        </div>
